...
public interface QueryContext {
	 ...
	 * @return Pagination
	 */
	<T> QueryConfig<T> getQueryConfig(Class<T> clazz);

	/**
	 * Retrieves the pagination according to the class type specified. If not
	 * existing, creates the pagination whenever {@code create} parameter is
	 * true.
	 * 
	 * @param clazz
	 *            a {@code Class} type
	 ...
	 * @return Pagination
	 */
	<T> QueryConfig<T> getQueryConfig(Class<T> clazz, boolean create);
